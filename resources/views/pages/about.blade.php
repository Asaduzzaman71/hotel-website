        ...
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-7 ml-auto order-lg-2 position-relative mb-5" data-aos="fade-up">
            <figure class="img-absolute">
              <img src="{{asset('frontend/images/food-1.jpg')}}" alt="Free Website Template by Templateux" class="img-fluid">
            </figure>
    ...
    <div class="container section">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
          <div class="block-2">
            <div class="flipper">
              <div class="front" style="background-image: url({{asset('frontend/images/person_3.jpg')}});">
                <div class="box">
                  <h2>Will Peters</h2>
                  <p>President</p>
                </div>
        ...
        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
          <div class="block-2"> <!-- .hover -->
            <div class="flipper">
              <div class="front" style="background-image: url({{asset('frontend/images/person_1.jpg')}});">
                <div class="box">
                  <h2>Jane Williams</h2>
        ...
        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
          <div class="block-2">
            <div class="flipper">
              <div class="front" style="background-image: url({{asset('frontend/images/person_2.jpg')}});">
                <div class="box">
              ...
              <div class="back">
                ...
                <div class="author d-flex">
                  <div class="image mr-3 align-self-center">
                    <img src="{{asset('frontend/images/person_2.jpg')}}" alt="">
                  </div>
