	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span>Hotel management system Admin</span></a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet">Rooms</span><span class="label label-important"> New</span></a>
							<ul>
								<li><a class="submenu" href="{{route('Room.index')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All rooms</span></a></li>
								<li><a class="submenu" href="{{route('Room.create')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add rooms</span></a></li>
